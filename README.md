...
|---|---|---|
| **Fraunhofer IIS Warehouse** | See https://www.kaggle.com/datasets/aftabhussaincui/warehouse-objects-dataset and  [original source] (#) (Löffler et al., 2018) | Subset of 13,187 images, 5 scene classes. Resized to 160×160 RGB. **Not redistributed here** — obtain from the source per its license. |
